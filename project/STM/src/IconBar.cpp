! $Id: IconBar.cpp,v 1.13 1997-04-10 17:29:16 granger Exp $
! 
! ------------------------------------------------------------------------
...
define widget iconbar menubar " "
	...
	menu help bitmap iconbar-help
		...
		entry 'Tutorial Page' 'help arm-tutorial'
		line
	...
	menu tools bitmap tools-big
		title 'Tools'
		line
		entry 'Help on Tools Menu' 'help tools'
		line
  ...
  "xterm -T ZebraShell -bg grey90 -fg purple -fn 8x13bold -e zstart -shell &"'
	...
	menu configs bitmap configs
		...
		line
		entry 'Help on Displays' 'help arm-displays'
		line
		...
		entry 'Sonde Skew-t plots' 'display sondes' \
			(dm$config = 'sondes')
		entry 'Sonde time-height profiles' 'display sonde-profile' \
...
!		entry 'Arkansas River Basin Precip' 'beep'
   ...
   'putc2 p_satoverlay platform avhrr_sgp.lat_lon field lat_lon_grid'
	...
	menu 'overlays' bitmap overlays
		...
		line
		entry 'Help on Overlays' 'help arm-iconbar'
		line
...
define widget siros intmenu 'siros'
	...
	entry 'Central Facility (also E13, Lamont)' \
		'PutScalar DsgpsirosE13.a1 hemisp_broadband'
	entry 'Extended Facility E4' \
		'PutScalar DsgpsirosE4.a1 hemisp_broadband'
	entry 'Extended Facility E7' \
		'PutScalar DsgpsirosE7.a1 hemisp_broadband'
	entry 'Extended Facility E9 (also Ashton)' \
		'PutScalar DsgpsirosE9.a1 hemisp_broadband'
#endif
	entry 'Extended Facility E8' \
		'PutScalar DsgpsirosE8.a1 hemisp_broadband'
	entry 'Extended Facility E11' \
		'PutScalar DsgpsirosE11.a1 hemisp_broadband'
	entry 'Extended Facility E13' \
		'PutScalar DsgpsirosE13.a1 hemisp_broadband'
	entry 'Extended Facility E15 (also Ringwood)' \
		'PutScalar DsgpsirosE15.a1 hemisp_broadband'
	entry 'Extended Facility E16' \
		'PutScalar DsgpsirosE16.a1 hemisp_broadband'
endmenu
