! $Id: IconBar.cpp,v 1.16 1999-04-13 21:56:52 granger Exp $
! 
! ------------------------------------------------------------------------
...
!
! In order for us to source active-loc modules, we need to mimic
! the dm command.
!
procedure dm cmd string
	#cmd
endprocedure

!
! A fixed context for gp modules called from the iconbar.  The module
! must reset the context if it changes it.
!
set icon_platform "iconbar"
require cf-active-loc
...
!			'display tseries' (dm$config = 'tseries')
	...
	menu central bitmap central
		title 'Central Facility'
		line
		submenu 'Platforms' cf-send-menu
	endmenu
...
define widget tower-menu intmenu 'tower platforms'
	...
	line
	entry "25m 1-minute (a0)" 'PutScalar sgp1twr25mC1.a0 temp'
	entry "60m 1-minute (a0)" 'PutScalar sgp1twr60mC1.a0 temp'
	entry "30-minute 10x (a1)" 'PutScalar sgp30twr10xC1.a1 temp'
	entry "25m 30-minute (a1)" 'PutScalar sgp30twr25mC1.a1 temp'
	entry "60m 30-minute (a1)" 'PutScalar sgp30twr60mC1.a1 temp'
#ifndef SAMEX
	entry "1-minute (a0)" 'PutScalar sgp1twr21xC1.a0 temp'
	entry "1-minute (a1)" 'PutScalar sgp1twr21xC1.a1 temp'
	entry "30-minute (a0)" 'PutScalar sgp30twr21xC1.a0 temp'
	entry "30-minute (a1)" 'PutScalar sgp30twr21xC1.a1 temp'
	entry "Daily (a0)" 'PutScalar sgp1440twr21xC1.a0 temp'
#endif
endmenu
#endif
