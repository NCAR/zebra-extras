! $Id: dm.pd.cpp,v 1.9 1997-06-02 22:55:26 granger Exp $
!
! ------------------------------------------------------------------------
...
parameter skewt-template skewt platform sgpsondewrpnC1.a1
...
! Cities
!
set cities1 "Tonkawa,Blackwell,Ponca-City,Enid,Stillwater,Tulsa,"
set cities2 "Arkansas-City,Winfield,Wellington,Wichita,Dodge-City,"
set cities3 "Oklahoma-City"
set cities concat3(cities1, cities2, cities3)
pdlift p_loc p_loc p_city_labels
parameter p_city_labels p_city_labels platform #cities
parameter p_city_labels p_city_labels icon littlecircle
parameter p_city_labels p_city_labels location-icon littlecircle
parameter p_city_labels p_city_labels color gray80
parameter p_city_labels p_city_labels icon-color gray80
...
parameter p_nws_station p_nws_station platform sgpnwssurfX1.a1
parameter p_nws_station p_nws_station icon meso_stations
...
parameter p_nws_contour p_nws_contour platform sgpnwssurfX1.a1
parameter p_nws_contour p_nws_contour field tdry
parameter p_nws_contour p_nws_contour icon mesonet
